...
Shader "Jefford/Terrian/3M BilinPhong"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // 高度混合因子
            half3 BlendWeight(half3 blendMap, half layer1Height, half layer2Height, half layer3Height, half BlendContract)
            {
                ...
                half3 blendFactor = half3( R,G,B);
                blendFactor = blendFactor / (R + G + B);
                return blendFactor;
            }
            ...
            half4 frag(Varyings i) : SV_Target
            {
                ...
                half3 blendFactor = BlendWeight(blendMap, layer1_Height, layer2_Height, layer3_Height, _BlendContract_All);

                half3 albedo = layer1_albedo * blendFactor.x + layer2_albedo * blendFactor.y + layer3_albedo * blendFactor.z;
                half3 normalWS = layer1_NormalWS * blendFactor.x + layer2_NormalWS * blendFactor.y + layer3_NormalWS * blendFactor.z ;
                half smoothness = layer1_Smoothness * blendFactor.x + layer2_Smoothness * blendFactor.y + layer3_Smoothness * blendFactor.z;
                half speculatIntensity = _Layer1_SpecularIntensity * blendFactor.x + _Layer2_SpecularIntensity * blendFactor.y + _Layer3_SpecularIntensity * blendFactor.z;
                half3 specularColor = _Layer1_SpecularColor.rgb * blendFactor.x + _Layer2_SpecularColor.rgb * blendFactor.y + _Layer3_SpecularColor.rgb * blendFactor.z;

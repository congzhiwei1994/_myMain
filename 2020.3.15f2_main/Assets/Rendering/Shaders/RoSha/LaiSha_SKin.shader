...
Shader "URP/Character/LaiSha/Skin"
{
    Properties
    {
        ...
        _SpecularIntensity("_SpecularIntensity",Range(0,3)) = 0

        [Header(Environment)]
        [NoScaleOffset]_EnvMap("_EnvMap",Cube) = "black"{}
        _EnvlIntensity("_EnvlIntensity",Range(0,1)) = 0
        ...
        Pass
        {
            ...
            half4 frag(Varyings i) : SV_Target
            {
                ...
                half3 diffuseCol;
                {
                    half3 diffuseCol_A;
                    {
                        diffuseCol_A = lerp(1,_Color_A,ramp * _Color_A_Intensity * vetexColor.r);
                    }
                    ...
                    half3 diffuseCol_B;
                    {
                        ...
                        diffuseCol_B = lerp(1,_Color_B,ramp * _Color_B_Intensity * vetexColor.g);
                    }
                ...
                half3 specColor;
                {
                    half specular = max(0.001,pow(NoH, _SpecularPow )) * _SpecularIntensity ;
                ...
                half3 envColor;
                {
                    ...
                    envColor *= fresnelColor * _EnvlIntensity * ramp;

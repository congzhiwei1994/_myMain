...
Shader "UI_Scene"
{
	Properties
	{
		...
		_UI_SceneMap("UI_SceneMap", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			TEXTURE2D(_UI_SceneMap);
			SAMPLER(sampler_UI_SceneMap);
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_UI_SceneMap = IN.ase_texcoord3.xy * _UI_SceneMap_ST.xy + _UI_SceneMap_ST.zw;
				float4 tex2DNode5 = SAMPLE_TEXTURE2D( _UI_SceneMap, sampler_UI_SceneMap, uv_UI_SceneMap );
				float3 linear_color8 = ( tex2DNode5 * tex2DNode5 ).rgb;
				float3 localACESTonemap8 = ACESTonemap8( linear_color8 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = localACESTonemap8;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_UI_SceneMap = IN.ase_texcoord2.xy * _UI_SceneMap_ST.xy + _UI_SceneMap_ST.zw;
				float4 tex2DNode5 = SAMPLE_TEXTURE2D( _UI_SceneMap, sampler_UI_SceneMap, uv_UI_SceneMap );
...
/*ASEBEGIN
Version=18400
7;338;1708;681;854;331.5;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;6;51,202.5;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;5;-378,-14.5;Inherit;True;Property;_UI_SceneMap;UI_SceneMap;0;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;56,-104.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CustomExpressionNode;8;142,-230.5;Inherit;False;float3 tonemapped_color = saturate((linear_color*(2.8 * linear_color + 0))/(linear_color*(2.0 * linear_color + 1.0) + 0.0))@$return tonemapped_color@;3;False;1;True;linear_color;FLOAT3;0,0,0;In;;Inherit;False;ACESTonemap;True;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=3A6CC2302D41761951F04C2A96E0D7FE34FB5548
...
Shader "Jefford/OceanLand/Toon_Fog"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float clampResult69 = clamp( pow( ( 1.0 - abs( ( ( texCoord59.y * 2.0 ) - 1.0 ) ) ) , _Exp ) , 0.0 , 1.0 );
				float4 lerpResult70 = lerp( _ColorB , _ColorA , clampResult69);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = (lerpResult70).rgb;
				float Alpha = (lerpResult70).a;
...
/*ASEBEGIN
Version=18400
113;106;1708;681;279.135;361.544;1;True;False
...
ASEEND*/
//CHKSM=D25B57082F8702DC2C614C42A6D80C74058CA9BF
...
public class ProjectWindowUtilEx
{
    ...
    {
        string path = Application.dataPath + "/3rd/TA/ShaderTemplate/Editor/Template/SimpleLit.shader";
    ...
    {
        string path = Application.dataPath + "/3rd/TA/ShaderTemplate/Editor/Template/LitURPShader.shader";
    ...
    {
        string path = Application.dataPath + "/3rd/TA/ShaderTemplate/Editor/Template/UnlitURPShader.shader";
